...
public:
    ...
    QPushButton *pushButtonAddCountry;
    QComboBox *comboBoxContragent;
    ...
    void setupUi(QWidget *TheAdressForm)
    {
        ...
        comboBoxCountry = new QComboBox(groupBox);
        comboBoxCountry->setObjectName(QString::fromUtf8("comboBoxCountry"));

        horizontalLayout->addWidget(comboBoxCountry);

        pushButtonAddCountry = new QPushButton(groupBox);
        pushButtonAddCountry->setObjectName(QString::fromUtf8("pushButtonAddCountry"));
        QSizePolicy sizePolicy(QSizePolicy::Maximum, QSizePolicy::Fixed);
        sizePolicy.setHorizontalStretch(0);
        sizePolicy.setVerticalStretch(0);
        sizePolicy.setHeightForWidth(pushButtonAddCountry->sizePolicy().hasHeightForWidth());
        pushButtonAddCountry->setSizePolicy(sizePolicy);
        pushButtonAddCountry->setMaximumSize(QSize(30, 16777215));

        horizontalLayout->addWidget(pushButtonAddCountry);


        gridLayout_3->addLayout(horizontalLayout, 2, 2, 1, 1);

        comboBoxContragent = new QComboBox(groupBox);
        comboBoxContragent->setObjectName(QString::fromUtf8("comboBoxContragent"));

        gridLayout_3->addWidget(comboBoxContragent, 0, 2, 1, 1);
    ...
    void retranslateUi(QWidget *TheAdressForm)
    {
        ...
        label_6->setText(QCoreApplication::translate("TheAdressForm", "Country", nullptr));
        pushButtonAddCountry->setText(QCoreApplication::translate("TheAdressForm", "...", nullptr));
    } // retranslateUi
