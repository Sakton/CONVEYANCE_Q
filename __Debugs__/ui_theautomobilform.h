...
public:
    ...
    void setupUi(QWidget *TheAutomobilForm)
    {
        ...
        TheAutomobilForm->resize(440, 608);
        ...
        gridLayout_2->addWidget(dateEditYearOfIssue, 3, 2, 1, 1);
        ...
        comboBoxMarka = new QComboBox(groupBox);
        comboBoxMarka->setObjectName(QString::fromUtf8("comboBoxMarka"));

        horizontalLayout_2->addWidget(comboBoxMarka);
        ...
        labelMarka = new QLabel(groupBox);
        labelMarka->setObjectName(QString::fromUtf8("labelMarka"));

        gridLayout_2->addWidget(labelMarka, 1, 0, 1, 1);
        ...
        gridLayout_2->addLayout(horizontalLayout_3, 5, 2, 1, 1);
        ...
        sizePolicy5.setHeightForWidth(lineEditWolumeCargon->sizePolicy().hasHeightForWidth());
        lineEditWolumeCargon->setSizePolicy(sizePolicy5);
        ...
        sizePolicy2.setHeightForWidth(comboBoxNotation->sizePolicy().hasHeightForWidth());
        comboBoxNotation->setSizePolicy(sizePolicy2);
    ...
    void retranslateUi(QWidget *TheAutomobilForm)
    {
        ...
        label->setText(QCoreApplication::translate("TheAutomobilForm", "Brand Auto", nullptr));
        dateEditYearOfIssue->setDisplayFormat(QCoreApplication::translate("TheAutomobilForm", "yyyy", nullptr));
        pushButtonAddAuto->setText(QCoreApplication::translate("TheAutomobilForm", "...", nullptr));
        pushButton->setText(QCoreApplication::translate("TheAutomobilForm", "...", nullptr));
        labelMarka->setText(QCoreApplication::translate("TheAutomobilForm", "Model  Auto", nullptr));
        pushButtonAddEco->setText(QCoreApplication::translate("TheAutomobilForm", "...", nullptr));
