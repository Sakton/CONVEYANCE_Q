...
public:
    ...
    void setupUi(QWidget *TheOrderForm)
    {
        ...
        sizePolicy2.setHeightForWidth(pushButtonAddCustomer->sizePolicy().hasHeightForWidth());
        pushButtonAddCustomer->setSizePolicy(sizePolicy2);
        pushButtonAddCustomer->setMinimumSize(QSize(0, 0));
        pushButtonAddCustomer->setMaximumSize(QSize(30, 16777215));
        ...
        sizePolicy10.setHeightForWidth(plainTextEditNotes->sizePolicy().hasHeightForWidth());
        plainTextEditNotes->setSizePolicy(sizePolicy10);
    ...
    void retranslateUi(QWidget *TheOrderForm)
    {
        ...
        pushButton->setText(QCoreApplication::translate("TheOrderForm", "...", nullptr));
        pushButtonAddCustomer->setText(QCoreApplication::translate("TheOrderForm", "...", nullptr));
        label_15->setText(QCoreApplication::translate("TheOrderForm", "Number", nullptr));
        label_3->setText(QCoreApplication::translate("TheOrderForm", "Counterparty", nullptr));
